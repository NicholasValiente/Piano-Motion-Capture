...
window.onload = function () {
    ...
    kinectSocket.onmessage = function (evt) {
        ...
        var maxsize=20;
        var outhead = document.getElementById("headdata");
        var outlefthand = document.getElementById("lefthanddata");
        var outrighthand = document.getElementById("righthanddata");
        ...
        outhead.innerHTML = joint[head].x.toString() + ","
            + joint[head].y.toString() + "," + joint[head].z.toString() ;
        outlefthand.innerHTML = joint[handleft].x.toString() + ","
            + joint[handleft].y.toString() + "," + joint[handleft].z.toString() ;
        outrighthand.innerHTML = joint[handright].x.toString() + ","
            + joint[handright].y.toString() + "," + joint[handright].z.toString() ;
    };
};
