...
var midi = new WebSocket("ws://137.154.151.239:3000/relay");
...
midi.onmessage = function (evt) 
               { 
                  ...
                  var midibox = document.getElementById("midiBox");
                  var playbackbox = document.getElementById("playbackBox");
				  if(data[0]!="playback")
				  {
					midibox.innerHTML +=  data[0] +" " + data[1] +" " + data[2] + "<br/>";
					midibox.scrollTop = textbox.scrollHeight;
				  }
				   if(data[0]=="playback"){
					playbackbox.innerHTML += data[1] +" " + data[2] +" " + data[3] + "<br/>";
